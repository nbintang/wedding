...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col gap-9 items-center justify-between ">
      <div
        id="hero"
      ...
      >
        <div data-aos="fade-down" className="min-w-full">
          <h1
            className={`${parisienFont.className} text-center bg-gradient-to-r from-cream-300 to-cream-900 bg-clip-text text-transparent flex flex-col items-center text-4xl sm:text-9xl  font-semibold`}
          >
